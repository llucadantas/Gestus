                ...
                <section className="w-full md:w-7/12 p-8 sm:p-10 lg:p-14 flex flex-col justify-center bg-[#120B18]">
                    <div className="max-w-md w-full mx-auto">
                        ...
                        <header className="mb-8 text-center md:text-left">
                            <h2 className="text-3xl font-bold text-[#F8F8F8] mb-2 tracking-tight">Cadastre seu Teatro</h2>
                            <p className="text-[#A1A1AA]">Preencha os dados abaixo para iniciar sua gestão.</p>
                        </header>
                        ...
                        <div className="mt-8 pt-6 border-t border-white/5 flex flex-col items-center">
                            <p className="text-sm text-[#A1A1AA] mb-4">Já possui um teatro cadastrado?</p>
                            <a href="/login" className="w-full sm:w-auto text-center px-6 py-3 border border-violet-500/20 bg-[#0B0710]/50 text-[#C4B5FD] font-medium rounded-xl hover:bg-[#7C3AED]/10 hover:border-[#7C3AED]/30 transition-all duration-300 focus:outline-none focus:ring-2 focus:ring-[#7C3AED]/50 flex justify-center items-center gap-2 text-sm sm:text-base shadow-sm">
